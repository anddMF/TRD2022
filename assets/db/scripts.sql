...
BEGIN
	SELECT eve.ID as 'id', typ.NAME as 'name', eve.INFO as 'info', eve.MOMENT as 'moment' FROM develop2020.trd2022_event eve INNER JOIN develop2020.trd2022_event_type typ on eve.ID_EVENT_TYPE = typ.ID 
    WHERE eve.ID >=  
    (
